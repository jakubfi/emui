...
static struct emui_style _emui_scheme_default[] = {
	...
	{ S_WINDOW_FRAME,	COLOR_BLACK,	COLOR_WHITE,	A_NORMAL },
	{ S_WINDOW_FRAME_F,	COLOR_BLACK,	COLOR_WHITE,	A_BOLD },
	{ S_WINDOW_TITLE,	COLOR_BLACK,	COLOR_WHITE,	A_BOLD },
	{ S_WINDOW_TITLE_F,	COLOR_BLACK,	COLOR_WHITE,	A_BOLD|A_REVERSE },

	{ S_TEXT_NORMAL,	COLOR_BLACK,	COLOR_WHITE,	A_NORMAL },
	{ S_TEXT_FOCUSED,	COLOR_CYAN,		COLOR_BLACK,	A_BOLD },
	{ S_TEXT_EDITED,	COLOR_CYAN,		COLOR_BLACK,	A_NORMAL },
	{ S_TEXT_CHANGED,	COLOR_RED,		COLOR_WHITE,	A_NORMAL },
